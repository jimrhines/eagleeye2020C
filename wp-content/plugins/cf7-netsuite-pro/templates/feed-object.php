<?php
  if ( ! defined( 'ABSPATH' ) ) {
     exit;
        ...
        <div class="vx_head">
<div class="crm_head_div"> <?php _e('4. Select the Object to create when a form is submitted.', 'contact-form-netsuite-crm'); ?></div>
...
<div class="crm_clear"></div> 
  ...
  <div class="vx_group">
    <div class="vx_row">
  <div class="vx_col1">
  <label for="vx_module" class="left_header"><?php _e("Netsuite Object", 'contact-form-netsuite-crm'); ?>
  <?php $this->tooltip("vx_sel_object") ?>
 </label>
  </div>
  <div class="vx_col2">
  <select id="vx_module" class="load_form crm_sel" name="object" autocomplete="off">
  <option value=""><?php _e("Select a Netsuite Object", 'contact-form-netsuite-crm'); ?></option>
  <?php 
  ...
  <button class="button" id="vx_refresh_fields" title="<?php _e('Refresh Fields','contact-form-netsuite-crm'); ?>">
  <span class="reg_ok"><i class="fa fa-refresh"></i> <?php _e('Refresh Fields','contact-form-netsuite-crm') ?></span>
  ...
  <div id="crm_ajax_div" style="display:none; text-align: center; line-height: 100px;"><i> <?php _e('Loading, Please Wait...','contact-form-netsuite-crm'); ?></i></div>
