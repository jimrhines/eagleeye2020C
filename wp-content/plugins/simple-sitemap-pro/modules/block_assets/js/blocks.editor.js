...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__simple_sitemap__ = __webpack_require__(145);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__simple_sitemap_group__ = __webpack_require__(153);
/**
 * Import blocks
 */
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__components_select_cpt__ = __webpack_require__(146);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__components_checkbox__ = __webpack_require__(139);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__components_color_picker_js__ = __webpack_require__(152);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_react_select__ = __webpack_require__(39);
// BLOCK DEPENDENCIES
...
/* unused harmony default export */ var _unused_webpack_default_export = (registerBlockType('wpgoplugins/simple-sitemap-block', {
	...
	edit: function edit(props) {
		var _props$attributes = props.attributes,
		    ...
		    horizontal = _props$attributes.horizontal,
		...
		return [wp.element.createElement(
			...
			wp.element.createElement(
				...
				wp.element.createElement(
					PanelRow,
					{ className: 'simple-sitemap' },
					wp.element.createElement(__WEBPACK_IMPORTED_MODULE_0__components_select_cpt__["a" /* SelectCPT */], { setAttributes: setAttributes, block_post_types: block_post_types })
				),
				wp.element.createElement(
					PanelRow,
				...
				wp.element.createElement(
					...
					wp.element.createElement(__WEBPACK_IMPORTED_MODULE_1__components_checkbox__["a" /* SitemapCheckboxControl */], { value: show_label, label: 'Show post type label', updateCheckbox: updateShowLabel })
				),
				wp.element.createElement(
					PanelRow,
					{ className: 'simple-sitemap general-chk' },
					wp.element.createElement(__WEBPACK_IMPORTED_MODULE_1__components_checkbox__["a" /* SitemapCheckboxControl */], { value: visibility, label: 'Display private posts', updateCheckbox: updateVisibility })
				),
				wp.element.createElement(
					PanelRow,
					{ className: 'simple-sitemap general-chk' },
					wp.element.createElement(__WEBPACK_IMPORTED_MODULE_1__components_checkbox__["a" /* SitemapCheckboxControl */], { value: horizontal, label: 'Enable horizontal sitemap', updateCheckbox: updateHorizontal })
				),
				wp.element.createElement(
					PanelRow,
					{ className: 'simple-sitemap general-chk' },
					wp.element.createElement(__WEBPACK_IMPORTED_MODULE_1__components_checkbox__["a" /* SitemapCheckboxControl */], { value: nofollow, label: 'Nofollow links', updateCheckbox: updateNofollow })
				),
				wp.element.createElement(
					PanelRow,
					{ className: 'simple-sitemap general-chk' },
					wp.element.createElement(__WEBPACK_IMPORTED_MODULE_1__components_checkbox__["a" /* SitemapCheckboxControl */], { value: links, label: 'Enable sitemap links', updateCheckbox: updateLinks })
				)
			),
			wp.element.createElement(
				PanelBody,
				{ title: __('Heading Settings', 'simple-sitemap'), initialOpen: false },
				wp.element.createElement(
					PanelRow,
					{ className: 'simple-sitemap' },
					wp.element.createElement(TextControl, {
						...
						onChange: function onChange(value) {
							setAttributes({ post_type_label_font_size: value });
						}
					})
				)
			),
			wp.element.createElement(
				PanelBody,
				{ title: __('Container Settings', 'simple-sitemap'), initialOpen: false },
				wp.element.createElement(
					PanelRow,
					{ className: 'simple-sitemap' },
					wp.element.createElement(TextControl, {
						...
						onChange: function onChange(value) {
							setAttributes({ sitemap_container_margin: value });
						}
					})
				)
			),
			wp.element.createElement(
				PanelBody,
				{ title: __('Sitemap Item Settings', 'simple-sitemap'), initialOpen: false },
				wp.element.createElement(
					PanelRow,
					{ className: 'simple-sitemap' },
					wp.element.createElement(TextControl, {
						...
						onChange: function onChange(value) {
							setAttributes({ sitemap_item_line_height: value });
						}
					})
				),
				wp.element.createElement(
					PanelRow,
					{ className: 'simple-sitemap' },
					wp.element.createElement(__WEBPACK_IMPORTED_MODULE_1__components_checkbox__["a" /* SitemapCheckboxControl */], { value: list_icon, label: 'Display list icons', updateCheckbox: updateShowListIcons })
				)
			),
			wp.element.createElement(
				PanelBody,
				{ title: __('Excerpt Settings', 'simple-sitemap'), initialOpen: false },
				wp.element.createElement(
					PanelRow,
					{ className: 'simple-sitemap' },
			...
			wp.element.createElement(
				PanelBody,
				{ title: __('Featured Image Settings', 'simple-sitemap'), initialOpen: false },
				wp.element.createElement(
					PanelRow,
					{ className: 'simple-sitemap' },
					wp.element.createElement(__WEBPACK_IMPORTED_MODULE_1__components_checkbox__["a" /* SitemapCheckboxControl */], { value: image, label: 'Display featured images', updateCheckbox: updateShowFeaturedImages })
				)
			),
			wp.element.createElement(
				PanelBody,
				...
				wp.element.createElement(
					PanelRow,
					{ className: 'simple-sitemap' },
					wp.element.createElement(__WEBPACK_IMPORTED_MODULE_1__components_checkbox__["a" /* SitemapCheckboxControl */], { value: render_tab, label: 'Enable tabs', updateCheckbox: updateToggleTabs })
				),
				render_tab && wp.element.createElement(
					Fragment,
					null,
					wp.element.createElement(
						PanelRow,
						{ className: 'tab-colors simple-sitemap' },
						wp.element.createElement(
							Fragment,
							null,
							wp.element.createElement(
							...
							wp.element.createElement(__WEBPACK_IMPORTED_MODULE_2__components_color_picker_js__["a" /* ColorDropdown */], { label: 'Active tab background', color: tab_header_bg, updateColor: updateTabBGColor }),
							wp.element.createElement(__WEBPACK_IMPORTED_MODULE_2__components_color_picker_js__["a" /* ColorDropdown */], { label: 'Active tab text', color: tab_color, updateColor: updateTabColor })
						)
					),
					wp.element.createElement(
						PanelRow,
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return SelectCPT; });
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_babel_runtime_core_js_get_iterator__ = __webpack_require__(36);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_babel_runtime_helpers_slicedToArray__ = __webpack_require__(58);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4_babel_runtime_core_js_object_entries__ = __webpack_require__(59);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5_babel_runtime_core_js_object_get_prototype_of__ = __webpack_require__(60);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6_babel_runtime_helpers_classCallCheck__ = __webpack_require__(61);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7_babel_runtime_helpers_createClass__ = __webpack_require__(62);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8_babel_runtime_helpers_possibleConstructorReturn__ = __webpack_require__(63);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9_babel_runtime_helpers_inherits__ = __webpack_require__(64);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_10_classnames__ = __webpack_require__(138);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_10_classnames___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_10_classnames__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_11_react_select__ = __webpack_require__(39);
...
var SelectCPT = function (_Component) {
	__WEBPACK_IMPORTED_MODULE_9_babel_runtime_helpers_inherits___default()(SelectCPT, _Component);

	function SelectCPT(props) {
		__WEBPACK_IMPORTED_MODULE_6_babel_runtime_helpers_classCallCheck___default()(this, SelectCPT);

		// or super(props); ??

		var _this = __WEBPACK_IMPORTED_MODULE_8_babel_runtime_helpers_possibleConstructorReturn___default()(this, (SelectCPT.__proto__ || __WEBPACK_IMPORTED_MODULE_5_babel_runtime_core_js_object_get_prototype_of___default()(SelectCPT)).call(this));
	...
	__WEBPACK_IMPORTED_MODULE_7_babel_runtime_helpers_createClass___default()(SelectCPT, [{
		key: 'componentDidMount',
		value: function componentDidMount() {
			var _this2 = this;
			...
			var url = 'simple-sitemap/v1/post-types';
			//const url = '/wp/v2/types';

			wp.apiFetch({ path: url, method: 'GET' }).then(function (data) {

				var post_types = [];

				var entries = __WEBPACK_IMPORTED_MODULE_4_babel_runtime_core_js_object_entries___default()(data);
				var _iteratorNormalCompletion = true;
				var _didIteratorError = false;
				var _iteratorError = undefined;

				try {
					for (var _iterator = __WEBPACK_IMPORTED_MODULE_2_babel_runtime_core_js_get_iterator___default()(entries), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
		...
		value: function render() {
			var _props = this.props,
			    ...
			    block_post_types = _props.block_post_types,
			...
			var selectStyles = {
				container: function container(styles) {
					return __WEBPACK_IMPORTED_MODULE_1_babel_runtime_helpers_extends___default()({}, styles, {
						'& div[class$="-Input"]': {
							'& input:focus': {
								boxShadow: 'none'
							}
			...
			return wp.element.createElement(__WEBPACK_IMPORTED_MODULE_11_react_select__["a" /* default */], {
				value: JSON.parse(block_post_types),
				isMulti: multi,
				onChange: function onChange(val) {
					return setAttributes({ block_post_types: __WEBPACK_IMPORTED_MODULE_0_babel_runtime_core_js_json_stringify___default()(val) });
				},
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return ColorDropdown; });
var _wp$components = wp.components,
    ColorPicker = _wp$components.ColorPicker,
    Dropdown = _wp$components.Dropdown;


var ColorDropdown = function ColorDropdown(props) {
  ...
  return wp.element.createElement(Dropdown, {
    ...
    renderToggle: function renderToggle(_ref) {
      ...
      return wp.element.createElement("div", { title: label, style: { backgroundColor: color, cursor: 'pointer' }, onClick: onToggle, "aria-expanded": isOpen });
    },
    renderContent: function renderContent() {
      return wp.element.createElement(ColorPicker, {
        color: color,
        onChangeComplete: function onChangeComplete(newCol) {
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__components_select_cpt_taxonomy__ = __webpack_require__(154);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__components_checkbox__ = __webpack_require__(139);
// BLOCK DEPENDENCIES
...
/* unused harmony default export */ var _unused_webpack_default_export = (registerBlockType('wpgoplugins/simple-sitemap-group-block', {
	...
	edit: function edit(props) {
		var _props$attributes = props.attributes,
		    ...
		    order = _props$attributes.order,
		    orderby = _props$attributes.orderby,
		    exclude_terms = _props$attributes.exclude_terms,
		    include_terms = _props$attributes.include_terms,
		    className = props.className,
		    setAttributes = props.setAttributes,
		    isSelected = props.isSelected,
		    attributes = props.attributes;
		...
		return [wp.element.createElement(
			...
			wp.element.createElement(
				...
				wp.element.createElement(
					PanelRow,
					{ className: 'simple-sitemap' },
					wp.element.createElement(__WEBPACK_IMPORTED_MODULE_0__components_select_cpt_taxonomy__["a" /* SelectCptTaxonomy */], { setAttributes: setAttributes, multi: false, block_post_type: block_post_type, block_taxonomy: block_taxonomy })
				),
				wp.element.createElement(
					PanelRow,
				...
				wp.element.createElement(
					PanelRow,
					{ className: 'simple-sitemap label-wide' },
					wp.element.createElement(TextControl, {
						label: 'Exclude taxonomy terms',
						help: 'Comma separated list of terms',
						value: exclude_terms,
						onChange: function onChange(value) {
							setAttributes({ exclude_terms: value });
						}
					})
				),
				wp.element.createElement(
					PanelRow,
					{ className: 'simple-sitemap label-wide mb20' },
					wp.element.createElement(TextControl, {
						label: 'Include taxonomy terms',
						help: 'Comma separated list of terms',
						value: include_terms,
						onChange: function onChange(value) {
							setAttributes({ include_terms: value });
						}
					})
				),
				wp.element.createElement(
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_babel_runtime_helpers_slicedToArray__ = __webpack_require__(58);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_babel_runtime_helpers_slicedToArray___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_1_babel_runtime_helpers_slicedToArray__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_babel_runtime_core_js_object_entries__ = __webpack_require__(59);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_babel_runtime_core_js_object_get_prototype_of__ = __webpack_require__(60);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_babel_runtime_core_js_object_get_prototype_of___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_3_babel_runtime_core_js_object_get_prototype_of__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4_babel_runtime_helpers_classCallCheck__ = __webpack_require__(61);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4_babel_runtime_helpers_classCallCheck___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_4_babel_runtime_helpers_classCallCheck__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5_babel_runtime_helpers_createClass__ = __webpack_require__(62);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5_babel_runtime_helpers_createClass___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_5_babel_runtime_helpers_createClass__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6_babel_runtime_helpers_possibleConstructorReturn__ = __webpack_require__(63);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7_babel_runtime_helpers_inherits__ = __webpack_require__(64);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7_babel_runtime_helpers_inherits___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_7_babel_runtime_helpers_inherits__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8_classnames__ = __webpack_require__(138);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8_classnames___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_8_classnames__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9_react_select__ = __webpack_require__(39);
...
var SelectCptTaxonomy = function (_Component) {
  ...
  __WEBPACK_IMPORTED_MODULE_5_babel_runtime_helpers_createClass___default()(SelectCptTaxonomy, [{
    ...
    value: function fetchCPTs() {
      ...
      var post_type_url = 'simple-sitemap/v1/post-types';

      wp.apiFetch({ path: post_type_url, method: 'GET' }).then(function (data) {
    ...
    value: function fetchTaxonomies(newCPT) {
      ...
      var _props2 = this.props,
          ...
          block_post_type = _props2.block_post_type,
          block_taxonomy = _props2.block_taxonomy;

      // use the cpt from attribute (component did mount) or from new value when cpt drop down changed

      var current_post_type_arr = void 0;
      if (newCPT) {
      ...
      var taxonomy_url = 'simple-sitemap/v1/post-type-taxonomies/' + current_post_type_arr;
      ...
      wp.apiFetch({ path: taxonomy_url, method: 'GET' }).then(function (data) {
        ...
        if (data.length === 0) {
          ...
          try {
            for (var _iterator2 = __WEBPACK_IMPORTED_MODULE_0_babel_runtime_core_js_get_iterator___default()(entries), _step2; !(_iteratorNormalCompletion2 = (_step2 = _iterator2.next()).done); _iteratorNormalCompletion2 = true) {
    ...
    value: function render() {
      ...
      var _props3 = this.props,
          ...
          block_post_type = _props3.block_post_type,
          block_taxonomy = _props3.block_taxonomy,
          _props3$multi = _props3.multi,
          multi = _props3$multi === undefined ? true : _props3$multi,
      ...
      return wp.element.createElement(
        ...
        wp.element.createElement(SelectControl, {
          ...
          options: this.state.types,
          onChange: function onChange(val) {
            return _this4.updatePostTypeValues(val);
          },
        ...
        wp.element.createElement(SelectControl, {
          ...
          onChange: function onChange(val) {
            return _this4.updateTaxonomyValues(val);
          },
