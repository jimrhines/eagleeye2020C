		...
		return [wp.element.createElement(
			...
			wp.element.createElement(
				...
				wp.element.createElement(
					...
					wp.element.createElement(__WEBPACK_IMPORTED_MODULE_3__components_checkbox__["a" /* SitemapCheckboxControl */], { value: show_excerpt, label: 'Show excerpt', updateCheckbox: updateExcerpt })
				),
				wp.element.createElement(
					PanelRow,
					{ className: 'simple-sitemap general-chk' },
					wp.element.createElement(__WEBPACK_IMPORTED_MODULE_3__components_checkbox__["a" /* SitemapCheckboxControl */], { value: show_label, label: 'Show post type label', updateCheckbox: updateShowLabel })
				),
				wp.element.createElement(
					PanelRow,
					{ className: 'simple-sitemap general-chk' },
					wp.element.createElement(__WEBPACK_IMPORTED_MODULE_3__components_checkbox__["a" /* SitemapCheckboxControl */], { value: links, label: 'Enable sitemap links', updateCheckbox: updateLinks })
				)
			),
			wp.element.createElement(
				PanelBody,
				...
				wp.element.createElement(
					...
					wp.element.createElement(__WEBPACK_IMPORTED_MODULE_3__components_checkbox__["a" /* SitemapCheckboxControl */], { value: render_tab, label: 'Enable tabs', updateCheckbox: updateToggleTabs })
				)
			),
			wp.element.createElement(
				PanelBody,
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__components_select_cpt_taxonomy__ = __webpack_require__(143);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__components_checkbox__ = __webpack_require__(137);
// BLOCK DEPENDENCIES
