...
<div class="wpcfr-popup-wrap wpcfr-popup-hidden <?php echo $template;?> middle-center">
    <div class="wpcfr-popup-wrap-inner">
        ...
        <div class="wpcfr-popup-wrap-content">
            <h3><?php _e('Record','wpcf7-redirect' );?></h3>
            <div class="wrapper">
            ...
            <h3><?php _e('Request','wpcf7-redirect' );?></h3>
            <div class="wrapper">
                <textarea name="name" rows="8" cols="80">
                    <?php
                        ob_start();
            ...
            <h3><?php _e('Response','wpcf7-redirect' );?></h3>
            <div class="wrapper">
                ...
                <?php else:?>
                    <div class="field-wrap">
                        <div class="label">
                            <label for=""><?php _e('Response code' ,'wpcf7-redirect' );?></label>
