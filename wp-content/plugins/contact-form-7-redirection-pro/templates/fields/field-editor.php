...
<div class="field-wrap field-wrap-<?php echo $field['name'];?> <?php echo isset( $field['class'] ) ? $field['class'] : '';?>">
    ...
    <?php wp_editor( $field['value'], 'editor-' . md5($field_name) , $settings = array( 'textarea_name' => $field_name , 'editor_class' => $css_class ) ); ?>
